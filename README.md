...
| -------------------------------------------------------------------------------------------------- | ------------------------------- | :----------: | --------------------------------------------------------------------------- |
| ![New](.gitbook/assets/new%20\(5\)%20\(19\)%20\(3\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(27\).png) | New                             |    Ctrl+N    | 템플릿 팝업을 열어 다른 템플릿 맵을 실행할 수 있습니다.                                            |
|                                                                                                    | Open From File                  |    Ctrl+O    | 로컬 파일이 저장된 폴더를 엽니다.                                                         |
|                                                                                                    | Open From DITOLAND              | Ctrl+Shift+O | 템플릿 팝업을 열어 DITOLAND 클라우드에 저장된 파일을 보여줍니다.                                    |
| ![Save](.gitbook/assets/save%20\(3\)%20\(1\)%20\(1\)%20\(10\)%20\(44\).png)                        | Save To File                    |    Ctrl+S    | 현재 편집중인 맵을 로컬 파일로 저장합니다.                                                    |
| ![Save](.gitbook/assets/save%20\(3\)%20\(1\)%20\(1\)%20\(10\)%20\(45\).png)                        | Save To File As                 | Ctrl+Shift+S | 현재 편집중인 맵을 새 로컬 파일로 저장합니다.                                                  |
...
| Icon                                                                                                | Action              |   Key  | Description                                                           |
| --------------------------------------------------------------------------------------------------- | ------------------- | :----: | --------------------------------------------------------------------- |
| ![Publish](.gitbook/assets/publish%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)                   | Publish To DITOLAND |        | File Menu의 Publish To DITOLAND 기능과 동일합니다. 현재 편집중인 맵을 클라우드 저장소에 저장합니다. |
| ![Save](.gitbook/assets/save%20\(3\)%20\(1\)%20\(1\)%20\(10\)%20\(46\).png)                         | Save To File        | Ctrl+S | File Menu의 Save To File기능과 동일합니다. 현재 편집중인 맵을 로컬 파일로 저장합니다             |
| ![Save](.gitbook/assets/new%20\(5\)%20\(19\)%20\(3\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(22\).png) | New                 | Ctrl+N | File Menu의 New 기능과 동일합니다. 템플릿 팝업을 열어 다른 템플릿 맵을 실행할 수 있습니다.            |
|                                                                                                     |                     |        |                                                                       |
...
| --------------------------------------------------------------------------------------------------- | --------------- | --------------------------------------------------------------------- |
| ![Play Mode](.gitbook/assets/play%20\(5\)%20\(13\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)   | Play Mode       | 실제 게임과 동일하게 시뮬레이션 하며, 캐릭터를 0,0,0 좌표로 스폰 됩니다.                          |
| ![Play Here Mode](.gitbook/assets/playhere%20\(5\)%20\(6\)%20\(1\)%20\(1\)%20\(10\)%20\(13\).png)   | Play Here Mode  | 캐릭터가 무조건 현재 카메라 좌표에서 스폰 되며 시뮬레이션을 시작합니다.                              |
| ![Run Camera Mode](.gitbook/assets/runcamera%20\(2\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png) | Run Camera Mode | 게임 시뮬레이션은 시작하지만 플레이어블 캐릭터는 생성하지 않습니다. 하지만 FreeCam 모드로 게임을 탐색할 수 있습니다. |
| ![Multi Test](.gitbook/assets/multiplay.png)                                                        | Multi Test      | Player를 거치지 않고 다수의 플레이어와 함께 게임을 플레이하는 상황을 재현할 수 있습니다.                 |

#### Object Control Tab

![](.gitbook/assets/objectcontroltab-2%20\(2\)%20\(1\)%20\(1\)%20\(1\)%20\(2\)%20\(2\).png)
...
![](.gitbook/assets/gizmo%20\(5\)%20\(8\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(15\).png)

| Icon                                                                                         | Action     | Key | Description                                  |
| -------------------------------------------------------------------------------------------- | ---------- | :-: | -------------------------------------------- |
| ![Select](.gitbook/assets/select%20\(2\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)              | Select     |  1  | 객체를 선택합니다. 선택한 객체는 드래그 동작으로 위치를 변경시킬 수 있습니다. |
| ![Move](.gitbook/assets/move%20\(5\)%20\(14\)%20\(3\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png) | Move       |  2  | 객체의 위치를 변경할 수 있습니다.                          |
| ![Rotate](.gitbook/assets/rotate%20\(1\)%20\(1\)%20\(2\)%20\(4\).png)                        | Rotate     |  3  | 객체의 각도를 변경할 수 있습니다.                          |
| ![Scale](.gitbook/assets/scale%20\(5\)%20\(11\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)       | Scale Mode |  4  | 객체의 사이즈 및 스케일을 변경할 수 있습니다.                   |

#### Object Control Setting Tab

![](.gitbook/assets/objectcontrolsettingtab%20\(5\)%20\(13\)%20\(6\)%20\(1\)%20\(1\)%20\(10\)%20\(17\).png)

Object Control의 방식이나 값들을 변경할 때 사용합니다.

| Icon                                                                                                     | Action             | Description                                                      |
| -------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------- |
| ![World](.gitbook/assets/world%20\(4\)%20\(1\)%20\(1\)%20\(10\)%20\(12\).png)                            | World Coordination | 현재 기즈모를 World 축으로 사용합니다. 클릭할 경우 Local Coordination으로 변경합니다.      |
| ![Local](.gitbook/assets/local-4%20\(4\)%20\(1\)%20\(1\)%20\(2\)%20\(3\).png)                            | Local Coordination | 현재 기즈모를 Local 축으로 사용합니다. 클릭할 경우 World Coordination으로 변경합니다.      |
| ![Grid](.gitbook/assets/gridsnap%20\(5\)%20\(14\)%20\(4\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png) | Grid Snap          | 기즈모 및 드래그로 객체를 이동시킬 때 Move , Rotate , Scale Size 값들을 변경할 수 있습니다. |
...
| Icon                                                                                                    | Action          | Description           |
| ------------------------------------------------------------------------------------------------------- | --------------- | --------------------- |
| ![Cube](.gitbook/assets/cube-3%20\(1\)%20\(1\)%20\(2\)%20\(1\).png)                                     | Cube            | 육면체형 객체를 배치합니다.       |
| ![Sphere](.gitbook/assets/sphere%20\(5\)%20\(9\)%20\(7\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png) | Sphere          | 구형 객체를 배치합니다.         |
| ![Cylinder](.gitbook/assets/cylinder-4%20\(3\)%20\(1\)%20\(1\)%20\(1\)%20\(2\)%20\(2\).png)             | Cylinder        | 원통형 객체를 배치합니다         |
| ![Plane](.gitbook/assets/plane%20\(5\)%20\(9\)%20\(2\)%20\(1\)%20\(1\)%20\(10\)%20\(17\).png)           | Plane           | 사각 판형 객체를 배치합니다       |
| ![Pyramid](.gitbook/assets/pyramid%20\(2\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)                       | Pyramid         | 피라미드형 객체를 배치합니다       |
| ![Wedge](.gitbook/assets/wedge%20\(5\)%20\(2\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(20\).png)           | Wedge           | 삼각기둥형 객체를 배치합니다       |
| ![Cone](.gitbook/assets/cone1.png)                                                                      | Cone            | 원뿔형 객체를 배치합니다         |
| ![Corner](.gitbook/assets/corner.png)                                                                   | Corner          | 기울어진 피라미드형 객체를 배치합니다. |
| ![CylinderQuater](.gitbook/assets/cylinder%20quarter.png)                                               | CylinderQuater  | ¼ 원통형 객체를 배치합니다.      |
| ![HemishereQuater](.gitbook/assets/hemisphere%20quarter.png)                                            | HemishereQuater | ¼ 구형 객체를 배치합니다.       |
...
| ![TorusQuarter](.gitbook/assets/torus%20quarter.png)                                                    | TorusQuarter    | ¼ 도넛 모양 객체를 배치합니다.    |
...
| Icon                                                                                                  | Action        | Description             |
| ----------------------------------------------------------------------------------------------------- | ------------- | ----------------------- |
| ![Emitter](.gitbook/assets/emitter-2%20\(5\)%20\(1\)%20\(1\)%20\(1\)%20\(2\)%20\(5\).png)             | Emitter       | Emitter FX를 배치합니다.      |
| ![Smoke](.gitbook/assets/smoke%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)                                 | Smoke         | Smoke FX를 배치합니다.        |
| ![Trail](.gitbook/assets/trail%20\(5\)%20\(14\)%20\(2\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)        | Trail         | Trail FX를 배치합니다         |
| ![Fire](.gitbook/assets/fire-3%20\(2\)%20\(1\)%20\(1\)%20\(1\)%20\(2\).png)                           | Fire          | Fire FX를 배치합니다          |
| ![Beam](.gitbook/assets/beam%20\(5\)%20\(14\)%20\(5\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)          | Beam          | Beam FX를 배치합니다          |
| ![Explosion](.gitbook/assets/explosion%20\(3\)%20\(5\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(15\).png) | Explosion     | Explosion FX를 배치합니다     |
...
| Icon                                                                                                  | Action           | Description                 |
| ----------------------------------------------------------------------------------------------------- | ---------------- | --------------------------- |
| ![Frame](.gitbook/assets/frame-4%20\(6\)%20\(1\)%20\(1\)%20\(1\).png)                                 | Frame Widget     | Frame Widget 객체를 배치합니다.     |
| ![Image](.gitbook/assets/image%20\(5\)%20\(9\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)                 | Image Widget     | Image Widget 객체를 배치합니다.     |
| ![Button](.gitbook/assets/button%20\(5\)%20\(13\)%20\(3\)%20\(1\)%20\(1\)%20\(10\)%20\(17\).png)      | Button Widget    | Button Widget 객체를 배치합니다.    |
| ![](.gitbook/assets/text%20\(5\)%20\(9\)%20\(7\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)       | Text Widget      | Text Widget 객체를 배치합니다.      |
| ![TextBox](.gitbook/assets/textbox%20\(5\)%20\(9\)%20\(4\)%20\(1\)%20\(1\)%20\(10\)%20\(17\).png)     | TextBox Widget   | TextBox Widget 객체를 배치합니다.   |
| ![ScrollBox](.gitbook/assets/scrollbox%20\(5\)%20\(9\)%20\(4\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png) | ScrollBox Widget | ScrollBox Widget 객체를 배치합니다. |
|                                                                                                       |                  |                             |
...
| Icon                                                                                                 | Action    | Description             |
| ---------------------------------------------------------------------------------------------------- | --------- | ----------------------- |
| ![WorldTree](.gitbook/assets/worldtree%20\(2\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)                | WorldTree | WolrdTree를 On / Off 합니다 |
| ![Property](.gitbook/assets/property%20\(5\)%20\(12\)%20\(1\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png) | Property  | Property를 On / Off 합니다  |
| ![ToolBox](.gitbook/assets/toolbox%20\(5\)%20\(1\)%20\(1\)%20\(10\)%20\(18\).png)                    | ToolBox   | ToolBox를 On / Off 합니다   |
| ![Palette](.gitbook/assets/palette%20\(6\)%20\(8\)%20\(1\)%20\(1\)%20\(10\)%20\(19\).png)            | Palette   | Palette를 On / Off 합니다   |
...
| Ctrl + Middle Mouse Button      | 카메라 축 이동       | 카메라가 바라보는 방향을 중심으로 회전합니다.                              |
...
![](.gitbook/assets/Untitled%20\(6\)%20\(1\).png)
...
.t1 table th:first-of-type { width : 10%; } .t1 table th:nth-of-type(2) { width : 30%; } .t1 table th:nth-of-type(3) { width : 20%; } .t1 table th:nth-of-type(4) { width : 40%; } .t2 table th:first-of-type { width : 10%; } .t2 table th:nth-of-type(2) { width : 30%; } .t2 table th:nth-of-type(3) { width : 20%; } .t2 table th:nth-of-type(4) { width : 40%; } .t3 table th:first-of-type { width : 10%; } .t3 table th:nth-of-type(2) { width : 30%; } .t3 table th:nth-of-type(3) { width : 60%; } .t4 table th:first-of-type { width : 10%; } .t4 table th:nth-of-type(2) { width : 20%; } .t4 table th:nth-of-type(3) { width : 10%; } .t4 table th:nth-of-type(4) { width : 60%; } .t5 table th:first-of-type { width : 10%; } .t5 table th:nth-of-type(2) { width : 30%; } .t5 table th:nth-of-type(3) { width : 60%; } .t6 table th:first-of-type { width : 10%; } .t6 table th:nth-of-type(2) { width : 20%; } .t6 table th:nth-of-type(3) { width : 70%; } .t7 table th:first-of-type { width : 10%; } .t7 table th:nth-of-type(2) { width : 40%; } .t7 table th:nth-of-type(3) { width : 50%; } .t8 table th:first-of-type { width : 10%; } .t8 table th:nth-of-type(2) { width : 40%; } .t8 table th:nth-of-type(3) { width : 50%; } .t9 table th:first-of-type { width : 10%; } .t9 table th:nth-of-type(2) { width : 40%; } .t9 table th:nth-of-type(3) { width : 50%; } .t10 table th:first-of-type { width : 30%; } .t10 table th:nth-of-type(2) { width : 25%; } .t10 table th:nth-of-type(3) { width : 45%; } .t11 table th:first-of-type { width : 25%; } .t11 table th:nth-of-type(2) { width : 25%; } .t11 table th:nth-of-type(3) { width : 50%; } .t12 table th:first-of-type { width : 10%; } .t12 table th:nth-of-type(2) { width : 30%; } .t12 table th:nth-of-type(3) { width : 60%; } .t13 table th:first-of-type { width : 20%; } .t13 table th:nth-of-type(2) { width : 80%; }
